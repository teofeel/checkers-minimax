            ...
            for column in range(COLS):
                ...
                if piece_analizing.is_queen:
                    ...
                    if not self.out_of_bounds(row_queen, column_temp1) and (self._board[row_queen][column_temp1]!=0 and 
                        ...
                        if not self.out_of_bounds(row_queen+piece_analizing.direction*-1, column_temp1-1) and self._board[row_queen+piece_analizing.direction*-1][column_temp1-1]==0:
                            available_pieces.append((row, column))
                    ...
                    if not self.out_of_bounds(row_queen, column_temp2) and (self._board[row_queen][column_temp2 ]!=0 
                        ...
                        if not self.out_of_bounds(row_queen+piece_analizing.direction*-1, column_temp2+1) and self._board[row_queen+piece_analizing.direction*-1][column_temp2+1]==0:
                            available_pieces.append((row, column))
